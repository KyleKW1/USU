    ...
    with st.form("assessment_form"):
        ...
        if submitted:
            response_data = {
                ...
                "financial_impact": financial_impact if financial_challenges == "Yes" else [],
                "financial_details": financial_details if financial_challenges == "Yes" else "",
                "academic_challenges": academic_challenges,
                "academic_impact": academic_impact if academic_challenges == "Yes" else [],
                "academic_details": academic_details if academic_challenges == "Yes" else "",
